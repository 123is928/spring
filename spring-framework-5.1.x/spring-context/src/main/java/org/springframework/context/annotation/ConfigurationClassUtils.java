...
abstract class ConfigurationClassUtils {
	 ...
	 * 		如果BeanDefinition 是 AnnotatedBeanDefinition的实例,并且className 和 BeanDefinition中
	 * 		的元数据的类名相同,则直接从BeanDefinition 获得Metadata
	 ...
	 * 		如果AnnotationMetadata 中有Component,ComponentScan,Import,ImportResource
	 * 		注解中的任意一个,或者存在 被@bean 注解的方法,则返回true.
	 * 		否则,返回false
